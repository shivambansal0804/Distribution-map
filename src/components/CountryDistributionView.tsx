...
export default function CountryDistributionView(props: { country: string; data: [[string|number,number|string]]; }) {
  const [region, setRegion] = useState("IN");
  const [data, setData] = useState<[[string|number,number|string]]>();
  useEffect(() => {
